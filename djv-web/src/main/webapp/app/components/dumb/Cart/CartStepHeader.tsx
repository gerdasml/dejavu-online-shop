...
export const CartStepHeader = (props: CartStepProps) =>
    (
        <Step.Group size="mini" id="stepGroup">
            ...
            <Step active={props.active === CartStep.CART}>
                <Icon name="cart"/>
                <Step.Content>
            ...
            <Step active={props.active === CartStep.DELIVERY_INFO}>
                <Icon name="truck"/>
                <Step.Content>
            ...
            <Step active={props.active === CartStep.PAYMENT}>
                <Icon name="payment" />
                <Step.Content>
            ...
            <Step active={props.active === CartStep.CONFIRMATION}>
                <Icon name="info" />
                <Step.Content>
            ...
            <Step active={props.active === CartStep.APPROVAL}>
                <Icon name="check" />
                <Step.Content>
